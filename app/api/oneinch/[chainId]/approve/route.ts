...
export async function GET(
  ...
  try {
    ...
    if (!queryParams.has("tokenAddress")) {
    ...
    const apiUrl = `https://api.1inch.dev/swap/v6.1/${chainId}/approve`;
    ...
    console.error("Error in 1inch approve API route:", error);
    return NextResponse.json(
